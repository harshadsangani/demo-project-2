...
// $config['csrf_expire'] = 60; //session expired in 1 minit
// $config['csrf_regenerate'] = TRUE;
// $config['csrf_exclude_uris'] = array();

//special for session erxpired
$config['sess_driver'] = 'files';
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 60; // session expires after 1 minute
